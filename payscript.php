<?php
 ...
 $apiKey = "rzp_test_Gqp9kdMHZNZhdy";
$ammount=100;
// $name="Suman";
?>
...
<script
    ...
    data-amount="<?php echo $ammount * 100;?>" // Amount is in currency subunits. Hence, 29935 refers to 29935 paise or ₹299.35.
...
<input type="hidden" name="order" value="<?php echo 'OID'.rand(10,100).'END';?>">
